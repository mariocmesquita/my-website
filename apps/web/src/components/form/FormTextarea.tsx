  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <textarea
        ...
        {...register(name)}
        {...props}
        className="min-h-24 resize-y rounded-lg border-1 border-brand bg-background px-3 py-2 text-sm text-foreground outline-none transition placeholder:text-foreground/40 focus:border-olive focus:ring-2 focus:ring-olive/30 hover:border-brand/80"
      />

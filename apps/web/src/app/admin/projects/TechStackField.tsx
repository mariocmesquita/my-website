    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-wrap gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-lg border-1 border-brand bg-background px-3 py-2 text-sm text-foreground outline-none transition placeholder:text-foreground/40 focus:border-brand focus:ring-2 focus:ring-brand/20 hover:border-brand/80"
        />
        <button
          type="button"
          onClick={add}
          className="shrink-0 rounded-lg border-1 border-brand bg-background px-3 py-2 text-sm font-medium text-foreground transition hover:bg-brand hover:text-brand-foreground"
        >
          Adicionar
        </button>
      </div>
